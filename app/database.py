...
def update_book(book_id, title, author_id, publisher_id, genre, publication_year, isbn):
    query = """
            UPDATE Books
            SET Title = %s, AuthorID = %s, PublisherID = %s, Genre = %s, PublicationYear = %s, ISBN = %s
            WHERE BookID = %s
            """
    params = (title, author_id, publisher_id, genre, publication_year, isbn, book_id)
...
def delete_book(book_id):
    ...
    return execute_write_query(query, (book_id,))
